...
**Architecture source of truth**: [`../../docs/005_architecture.md`](../../docs/005_architecture.md) at the repository root.
...
**Constraints** (binding; flow from `../../docs/005_architecture.md`, the spec, and the constitution):
...
- Architecture-level decisions (region pair, identity flavour, egress scope, URL-path style) are captured in `../../docs/005_architecture.md` (the source of WHAT) and the spec's Clarifications block (the resolved decisions). This plan does not re-decide them.
...
- The plan does not propose edits to `../../docs/005_architecture.md`, the constitution, or any other speckit feature directory.
...
- The canonical architecture document is `../../docs/005_architecture.md`. This plan, the spec, and all subsequent artifacts defer to it. No architectural decision is invented in `plan.md` that is not already present in `../../docs/005_architecture.md` or recorded in `spec.md` § Clarifications.
