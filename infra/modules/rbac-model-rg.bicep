...
// AVM gap: avm/res/authorization/role-assignment/rg-scope:0.1.1 in this
...
// hop from APIM to Foundry/AOAI requires the *OpenAI User* role. The
// architecture explicitly forbids the swap.
